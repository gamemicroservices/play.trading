    ...
    public class Startup
    {
        ...
        private void AddMassTransit(IServiceCollection services)
        {
            services.AddMassTransit(configure => 
            {
                ...
                configure.AddSagaStateMachine<PurchaseStateMachine, PurchaseState>(sageConfigurator => {
                    sageConfigurator.UseInMemoryOutbox();
                })
                    .MongoDbRepository(r => 
                    {
            ...
            EndpointConvention.Map<DebitGil>(new Uri(queueSettings.DebitGilQueueAdress));
